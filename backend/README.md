...
## Project Structure
    ...
    ├── anotherappcreation__68109  # Django project configurations
...
1. Clone this repo and `cd anotherappcreation__68109`
...
2. Clone this repo and `cd anotherappcreation__68109`
